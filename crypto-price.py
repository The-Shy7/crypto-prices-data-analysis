...
st.markdown(""" 
    This app retrieves prices for the top 100 cryptocurrencies from **CoinMarketCap**
""")
...
# data prep for bar plot of % price change
